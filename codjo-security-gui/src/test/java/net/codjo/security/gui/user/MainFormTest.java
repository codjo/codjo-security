...
public class MainFormTest extends UISpecTestCase {
    ...
    public void test_validate() throws Exception {
        ...
        WindowInterceptor
              ...
              .process(BasicHandler.init()
                             .assertContainsText("Voulez-vous vraiment enregistrer le modèle ?")
    ...
    public void test_editComposite_Assigned() throws Exception {
        ...
        assertTrue(getTabbedPane().selectedTabEquals("Rôles"));
    ...
    private void assertThatGuiExistsFor(UserManagement type) {
        try {
            ...
            fail("La stratégie de gestion utilisateur " + type + " ne possède pas d'IHM associé."
